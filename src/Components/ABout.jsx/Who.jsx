        ...
        <div className='lg:w-[50%] flex flex-col gap-5'>
            ...
            <div className='mt-5 flex flex-col gap-8'>
                <div className='w-[100%] inline-flex  lg:gap-8 max-lg:gap-3 '>
                    <div className='lg:w-[30%] flex max-lg:w-[50px]  h-[50px] font-bold  rounded-md bg-gray-300 items-center justify-center '>
                    <FaCheck  className='inline-block'/>
                    </div>
                    <p className='text-black inline-flex max-lg:w-[90%] max-md:text-md md:text-lg'>
