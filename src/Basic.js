  ...
  return (
    <div>
      <div className="flex flex-col gap-4 text-left justify-start p-3 mt-[1rem] flex-wrap">
        ...
        <p className="text-gray-500 flex-wrap max-[566px]:w-[20rem]">
      ...
      <form className=" gap-3 pag-y-10 p-3" onSubmit={handleSubmit}>
        ...
        ref={name}
          ...
          className="w-[80%] max-[566px]:w-[20rem] h-[2.4rem] border-black border-2"
          required
          onChange={(e)=>setData({...data,name:e.target.value})}
        />
        <p>{errors.name}</p>
        <Typography className="pt-4">You mobile number</Typography>
        <div className="border-2 w-fit h-fit  border-black">
          ...
          ref={number}
            ...
            className="p-2 w-[16.6rem] h-[3rem]"
            required
        ...
        ref={email}
          ...
          className="w-[80%] max-[566px]:w-[20rem] p-2 h-[2.4rem] border-black border-2"
          onChange={(e)=>setData({...data,email:e.target.value})}
          required
        />
  <div>
            <Typography>Choose Courses</Typography>
            <select className="w-[80%] max-[566px]:w-[20rem]  p-2 h-[2.4rem] border-black border-2" ref={course} onChange={(e)=>setData({...data,course:e.target.value})}>
        ...
        <div className="md:flex max-[996px]:flex-col gap-4 pt-4">
          <div>
            ...
            <select  className="w-[20rem] p-2 h-[2.4rem] border-black border-2" ref={interest} onChange={(e)=>setData({...data,interest:e.target.value})}>
              <option value="" selected="" disabled="">
                I'm interested in
              </option>
              <option value={"Online"}>
          ...
          <div>
            ...
            <select className="w-[20rem] p-2 h-[2.4rem] border-black border-2" ref={campus} onChange={(e)=>setData({...data,campus:e.target.value})}>
              <option value="" selected="" disabled="">
                Select campus
              </option>
